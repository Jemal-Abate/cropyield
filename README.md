...
This repository contains the source code, notebooks, datasets (where permitted), and trained models accompanying the following publication:
...
git clone https://github.com/Jemal-Abate/cropyield.git
cd cropyield
